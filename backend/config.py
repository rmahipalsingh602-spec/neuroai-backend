...
class Settings:
    ...
    ai_context_chunks: int = int(os.getenv("AI_CONTEXT_CHUNKS", "6"))
    ai_chunk_words: int = int(os.getenv("AI_CHUNK_WORDS", "170"))
    ai_chunk_overlap_words: int = int(os.getenv("AI_CHUNK_OVERLAP_WORDS", "40"))
    ai_history_turns: int = int(os.getenv("AI_HISTORY_TURNS", "4"))
